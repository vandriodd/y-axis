export default function TestimonialCard({ img, name, role, company, quote }) {
  return (
    <article className="bg-bg-secondary border-gray border-[0.5px] rounded-2xl w-[360px] h-[360px] flex flex-col justify-between p-8">
      <p className="mb-3 font-normal text-foreground text-lg">
        {quote}
      </p>
